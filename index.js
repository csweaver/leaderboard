...
/***/ function(module, exports, __webpack_require__) {
	...
	var _maxBy = __webpack_require__(168);
	...
	var getMinIndexTimeArray = function getMinIndexTimeArray(arr) {
		var millisArr = arr.map(function (i) {
			var splitTime = i.split(':');
			var millis = Infinity;
			if (splitTime[0] != '-') {
				millis = parseInt(splitTime[0]) * (1000 * 60);
				var secondsSplit = splitTime[1].split('.');
	...
	var Times = function Times(props) {
		var times = [];
		var minArr = getMinIndexTimeArray(props.times);
		var minIdx = minArr.indexOf(Math.min.apply(Math, _toConsumableArray(minArr)));
		for (var i = 0; i < props.times.length; i++) {
			var clsName = 'time ';
			var time = props.times[i];
			if (time[0] === '-') {
				clsName += "incomplete ";
	...
	var Team = function Team(props) {
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				'div',
				{ className: 'team-icon' },
				_react2.default.createElement('img', { src: props.icon, alt: 'the team' })
			),
			_react2.default.createElement(
				'div',
				{ className: 'team-name' },
	...
	var LBItem = function LBItem(props) {
		var icon = 'assets/img/bronze-star.jpg';
		if (props.idx == 0) icon = 'assets/img/golden-star.jpg';else if (props.idx == 1) icon = 'assets/img/silver-star.jpg';
		return _react2.default.createElement(
			'div',
			{ className: 'lb_item' },
			_react2.default.createElement(Team, { name: props.team, number: props.number, icon: icon, members: props.members }),
			_react2.default.createElement(Times, { times: props.times })
		);
	};
		...
		_createClass(Leaderboard, [{
			...
			value: function render() {
				...
				data.sort(function (a, b) {
					var amin = Math.min.apply(Math, _toConsumableArray(getMinIndexTimeArray(a.times)));
					var bmin = Math.min.apply(Math, _toConsumableArray(getMinIndexTimeArray(b.times)));

					return amin - bmin;
				});
				console.log(data);
				var teams = [];
				for (var teamIdx in data) {
					var team = data[teamIdx];
					var number = parseInt(teamIdx) + 1;
					teams.push(_react2.default.createElement(LBItem, { team: team.name, members: team.members, number: number, times: team.times, idx: teamIdx, key: 'team' + teamIdx }));
				}
				return _react2.default.createElement(
					'div',
					{ 'class': 'leaderboard' },
	...
	(0, _reactDom.render)(_react2.default.createElement(Leaderboard, { data: data }), document.getElementById('content'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {var checkGlobal = __webpack_require__(203);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseHas = __webpack_require__(230),
	    ...
	    indexKeys = __webpack_require__(234),
